...
producto.push(new Productos(1, "Almohadon de pana ", 700, 0, "40x40 cm"));
producto.push(new Productos(2, "Almohadon de tusor ", 700, 0, "40x40 cm"));
producto.push(new Productos(3, "Almohadon de gasa ", 800, 0, "50x30 cm"));
producto.push(new Productos(4, "Almohada para cama ", 1300, 0, "50x40 cm"));
producto.push(new Productos(5, "Cortinas de gasa ", 13000, 0, "200x150 cm"));
producto.push(new Productos(6, "Cortinas de tusor ", 15000, 0, "200x150 cm"));
producto.push(new Productos(7, "Cortinas de lino ", 17000, 0, "200x150 cm"));
producto.push(new Productos(8, "Cortinas de Blackout ", 18000, 0, "200x150 cm"));
producto.push(new Productos(9, "Cortinas de pana ", 15000, 0, "200x150 cm"));
producto.push(new Productos(10, "Mantel de tusor ", 5000, 0, "200x150 cm"));
producto.push(new Productos(11, "Mantel waffle ", 7000, 0, "200x150 cm"));
producto.push(new Productos(12, "Mantel gasa ", 5000, 0, "200x150 cm"));
producto.push(new Productos(13, "Delantal ", 1500, 0, "70x40 cm"));
producto.push(new Productos(14, "Juego de servilletas x 8 ", 4000, 0, "40x40 cm"));
producto.push(new Productos(15, "Juego sabanas para cama king ", 20000, 0, "200 x 200 cm"));
producto.push(new Productos(16, "Juego sabanas para cama Queen ", 18000, 0, "160 x 200 cm"));
producto.push(new Productos(17, "Juego sabanas para cama 2 plazas y media ", 14000, 0, "140 x 190cm"));
producto.push(new Productos(18, "Juego sabanas para cama 1 plaza y media ", 10000, 0, "190 x 090 cm"));
producto.push(new Productos(19, "Pie de cama ", 9000, 0, "200 x 150 cm"));
...
//         <div class="card">
//             <div class="card-body">
//                 <p class="card-text">Nombre: <b>${producto[0].nombre}<b></p>
//                 <p class="card-text">Tamaño: <b>${producto[0].tamaño}<b></p>
//                 <p class="card-text">Precio: <b>${producto[0].precio}<b></p>
//             </div>
//         </div>
//     `;
...
for (let i=0; i< producto.length;i++){
    ...
    columna.innerHTML =`
        <div class="card">
            <div class="card-body">
                <p class="card-text">Nombre: <b>${Productos.nombre}<b></p>
                <p class="card-text">Tamaño: <b>${Productos.tamaño}<b></p>
                <p class="card-text">Precio: <b>${Productos.precio}<b></p>
            </div>
        </div>
    `;
